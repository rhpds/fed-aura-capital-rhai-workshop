...
* link:https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/2.18/html/managing_openshift_ai/managing-observability_managing-rhoai[Red Hat OpenShift AI (RHOAI) Observability Guide^]: Managing observability in RHOAI
